...
=======================================================================
ВНИМАНИЕ!
Данный пакет содержит более старую версию - PHP 5.2. В настоящий момент
с этой версией меньше проблем у популярных CMS (Joomla и т.д.), а также
поддерживается Zend Optimizer (в 5.3 Zend Optimizer пока недоступен). 
=======================================================================
